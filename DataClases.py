...
# Las dataclass son buenas en el caso de que necesitemos una clase sencilla y directa sin muchas validaciones
...
print(f'{persona1!r}'.center(100,"-"))
# Variable de clase
print(f'Variable clase: {Persona.contador_personas}'.center(50,"-"))
# Variables de instancia
print(f'Variables de instancia: {persona1.__dict__}'.center(150,"-"))
# Variable con valores vacíos
persona_vacia = Persona('Karla','', None)
print(f'Persona vacía: {persona_vacia}'.center(150,"-"))
# Revisar igualdad entre objetos (__eq__)
persona2 = Persona('Juan','Perez', Domicilio('Saturno', 15))
print(f'Objetos iguales?: {persona1 == persona2}'.center(100,"-"))
