...
class listaSimple:
    ...
    def __repr__(self):
        return f"{self.__class__}{self._elementos!r}"
...
lista_enteros_ordenada = ListaEnterosOrdenada([3,5,6,-1,2,10,123])
...
print("Es de varios tipos?:",isinstance(ListaEnterosOrdenada,(ListaEnteros,listaSimple)))
